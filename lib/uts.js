...
function moveClawDown(distance, speed, callback) {
    let step = 0;
...
function moveClawUp(distance, speed, callback) {
    let step = 0;
    const steps = Math.abs(distance / speed);
    const interval = setInterval(() => {
    claw.y -= speed;
...
function moveClawRight(distance, speed, callback) {
    let step = 0;
    const steps = Math.abs(distance / speed);
    const interval = setInterval(() => {
    claw.x += speed;
...
function moveClawLeft(distance, speed, callback) {
    let step = 0;
    const steps = Math.abs(distance / speed);
    const interval = setInterval(() => {
    claw.x -= speed;
